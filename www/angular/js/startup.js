    ...
    return function () {
        ...
        if (window.e2emocks) {
            ...
            mockedApp.run(function ($httpBackend) {
                ...
                $httpBackend.whenPOST('/couchdb/_session').respond(200, {ok: true, userCtx: {name: 'a_new_username', roles: ['+admin']}, info: {authentication_db: "_users", authentication_handlers: ["oauth", "cookie", "default"]}});
