...
module.exports = (function (conf, q, foreach, ensure, colors) {
	"use strict";
	        ...
	        q.all(databaseDeferreds.concat(usersDeferreds)).then(function () {
	                ...
	                foreach(userdbs, function (i, dbname) {
	                    var username = dbname.substring(15);
							...
							source: dbname,
							target: "commissar_private",
							filter: "validation_global/should_copy_to_private"
	                    }, echoError);
	                    ensure.replication({
							source: "commissar_private",
							target: dbname,
							filter: "validation_global/should_copy_to_personal"
	                    }, echoError);
	                });
	            });
	        });
...
})(require('./utils/conf'), require('q'), require('./utils/foreach'), require('./utils/configured_couchEnsure'), require('colors'));
